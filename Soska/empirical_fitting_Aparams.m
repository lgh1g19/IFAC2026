function [model_obj, q1_val_norm, q2_val_norm, q3_val_norm, model_obj_log, opt_time] = empirical_fitting_Aparams(q1_fit,q2_fit,q3_fit, q1_val, q2_val,q3_val, v1, v2, init_estimate)
...
[model_obj.params, model_obj.tend, model_obj.m, model_obj.gen]=param_return(); %Begin with default model parameters
...
%assign model resting angle based on the average angle when no input is applied 
...
%Carry out a single local optimisation step from the randomly initialised
%start point
tic
...
%%%%%%%%%%
%Assign optimised parameters to model structure
...
%Evaluate fitting accuracy of the identified model
[q1_val_norm, q2_val_norm, q3_val_norm, ~]=assessFit_newData(model_obj, q1_val, q2_val, q3_val,v1, v2);
