...
%Frictional force/ stiffness matrix F(q, q_dot)
...
t_dot1=q_dot(1); t_dot2=q_dot(2); t_dot3=q_dot(3);
    ...
    k1=1/(a1*(theta1-q_cutoff1))+k1; %eqn (34) in https://eprints.soton.ac.uk/493127/
    k2=1/(a2*(theta2-q_cutoff2))+k2;
    k3=1/(a3*theta3)+k3; %Assuming cutoff angle of zero



F=[-k1*(t_01-theta1)+b1*t_dot1; %eqn (33) in https://eprints.soton.ac.uk/493127/
